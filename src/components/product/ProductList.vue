...
<template>
  <div class="productContent">
    <div class="productContent__nav">
      <div class="contentTitle">Product</div>
      <ul class="productContent__filter">
        <li
          ...
          <div
            ...
            <span>{{ specDatas.origin.name.en }}</span>
          ...
          <ul>
            <li
              ...
              @click="activeFilter('origin', origin.en)">{{ origin.en }}</li>
          </ul>
        </li>
        <li
          ...
          <div
            ...
            <span>{{ specDatas.appearance.name.en }}</span>
            <div class="switchButton"></div>
          </div>
          <ul>
            <li
              ...
              @click="activeFilter('appearance', appearance.en)">{{ appearance.en }}</li>
          </ul>
        </li>
        <li
          ...
          <div
            ...
            <span>{{ specDatas.functionality.name.en }}</span>
            <div class="switchButton"></div>
          </div>
          <ul>
            <li
              ...
              @click="activeFilter('functionality', functionality.en)">{{ functionality.en }}</li>
          </ul>
        </li>
        <li
          ...
          <div
            ...
            <span>{{ specDatas.support.name.en }}</span>
            <div class="switchButton"></div>
          </div>
          <ul>
            <li
              ...
              @click="activeFilter('support', support.en)">{{ support.en }}</li>
          </ul>
        </li>
        <li
          ...
          <div
            ...
            <span>{{ specDatas.brands.name.en }}</span>
            <div class="switchButton"></div>
          </div>
          <ul>
            <li
